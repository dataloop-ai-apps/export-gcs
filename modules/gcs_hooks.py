...
class GCSExport(dl.BaseServiceRunner):
    def __init__(self):
        ...
        try:
            ...
            raise ValueError(f"Unable to decode the service account JSON. "
                             f"Please refer to the following guide for proper usage of GCP service accounts with"
                             f"Dataloop: https://github.com/dataloop-ai-apps/export-gcs/blob/main/README.md")
